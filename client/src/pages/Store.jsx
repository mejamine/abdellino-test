    ...
    return (
            ...
            <section className='pt-32' >                
                ...
                <div className='grid  md:grid-cols-2 lg:grid-cols-3 '>
                        ...
                        <div className="flex items-center gap-2 col-span-1 justify-center pr-3">
                                ...
                                className="mb-4 p-2 w-[30vw] md:w-[50vw] border rounded pt-2"
                                />
                        </div>
                    </div>
                        ...
                        <div id="Produit" className="produit_container  pb-10 pt-2">
                            {
                                loading
                                    ...
                                    <div className="loading_container mt-40 flex items-center justify-center flex-col">
                                        <FaSearch className='font-xl text-red-500 font-bold text-xl text-center' />
                                        <p className='font-heading text-lg text-center text-red-500 '>Searching...</p>
                                    </div>
                                    :
     ...
     :
        <div className=" mt-40 flex items-center justify-center flex-col">
            ...
            <p className='font-heading text-lg text-center text-[#3A5A40] '>Sorry, Poduct not found</p>
         </div>
